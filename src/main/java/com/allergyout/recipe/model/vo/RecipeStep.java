...
public class RecipeStep {
    ...
    private final String stepImg;     // STEP_IMG VARCHAR2(300) NULLABLE (원본 파일명, 스텝 이미지 선택)
    private final Integer stepOrder;  // STEP_ORDER NUMBER (RECIPE_NO와 UNIQUE)
    private final String stepImgPath; // STEP_IMG_PATH NVARCHAR2(300) NULLABLE (S3 버킷 URL, ALTER로 NULL 허용 적용됨)
}
